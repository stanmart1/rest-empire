...
from app.api.v1.endpoints import (
    ...
    payments, payouts, notifications, events, promo_materials, books, activation, support, verification, crypto_signals, dashboard, videos, content, faq, blog, about, contact
)
