...
const Footer = () => {
  ...
  let contactInfo = { phone: '', email1: '', office_address: '', office_city: '' };
  try {
    contactInfo = JSON.parse(contactData?.content || '{}');
  } catch {}

  let socialLinks = { facebook: '', instagram: '', twitter: '', linkedin: '' };
  try {
    socialLinks = JSON.parse(socialData?.content || '{}');
  } catch {}
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              {socialLinks.facebook && (
                <a href={socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary">
              ...
              {socialLinks.linkedin && (
                <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/book-review" className="text-gray-300 hover:text-primary">Book Review</Link></li>
              <li><Link to="/3x21-program" className="text-gray-300 hover:text-primary">3X21 Days Program</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <svg className="h-5 w-5 text-gray-300 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                <span className="text-gray-300">{contactInfo.phone || '+2340123456789'}</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 text-gray-300 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <span className="text-gray-300">{contactInfo.email1 || 'support@restempire.com'}</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 text-gray-300 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-gray-300">{contactInfo.office_address || 'Oba Akran, Ikeja'}<br />{contactInfo.office_city || 'Lagos, Nigeria'}</span>
              </li>
            </ul>
          </div>
        </div>
