  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-3xl md:text-4xl font-bold text-center mb-4">About the Founder</DialogTitle>
        </DialogHeader>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-1/3 flex-shrink-0">
            ...
            <div className="mt-4 text-center">
              <h3 className="text-xl font-bold text-foreground">Ayodele Kikelomo</h3>
              <p className="text-primary font-semibold">Founder & CEO</p>
            </div>
          </div>
          
          <div className="md:w-2/3 space-y-5 text-muted-foreground">
