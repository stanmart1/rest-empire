        ...
        <div className="container mx-auto px-4 py-28 md:py-36 lg:py-44 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-foreground/90 mb-10 max-w-2xl mx-auto">
              Empowering minds through knowledge sharing and capacity development
            </p>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16 relative z-10 bg-background">
        <div className="max-w-4xl mx-auto">
          <div className="bg-card rounded-xl border p-8 md:p-12 space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">About Motivational Talk</h2>
            
            <p className="text-lg text-muted-foreground leading-relaxed">
              This program which is designed to continually inform the mind & combat ignorance, usually takes the form of the book review in the sense that it is also, usually employed during our BREAKFAST MEETINGS. It is also a ONE WEEK (Mondays - Fridays) program whereby one of our leaders, is appointed for one week, in a month, to TEACH, SHARE CONTENT/CONCEPTS or MOTIVATE our members each day, within the week in question, for a 15-20 minutes SESSION.
            </p>
            
            <p className="text-lg text-muted-foreground leading-relaxed">
              So, because our Community is condensed with professionals in diverse fields, our MOTIVATIONAL TALKS are power packed sessions where these erudite & scholarly professionals, share insights on an avalanche of TOPICS designed to ensure the continuous sharing of knowledge, expertise, skills & relevant information that will enhance & accelerate CAPACITY DEVELOPMENT for our esteemed Community members.
            </p>
          </div>
        </div>
      </div>
...
export default MotivationalTalk;
