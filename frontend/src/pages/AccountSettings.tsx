                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Input type="file" accept="image/*,.pdf" onChange={(e) => setDocumentFile(e.target.files?.[0] || null)} className="mt-2" />
                      {documentFile && <p className="text-sm text-muted-foreground mt-1">{documentFile.name}</p>}
                    </div>
                  </div>
